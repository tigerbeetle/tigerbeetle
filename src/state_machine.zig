...
test "get_account_history: two-phase" {
    try check(
        ...
        \\ transfer T2 A2 A1    2   _  _  _  _    0 L1 C1   _ PEN   _   _   _   _  _ _ ok
        \\ transfer T3 A1 A2    _  T1  _  _  _    0 L1 C1   _   _ POS   _   _   _  _ _ ok
        \\ commit create_transfers
        \\
        \\ get_account_history A1 _ _ 10 DR CR  _
        \\ get_account_history_result T1 1 0 0 0
        \\ get_account_history_result T2 1 0 2 0
        \\ get_account_history_result T3 0 1 2 0
        \\ commit get_account_history
    );
}
