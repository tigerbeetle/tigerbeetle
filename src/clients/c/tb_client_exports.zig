...
pub const tb_create_account_status = vsr.tigerbeetle.CreateAccountStatus;
pub const tb_create_transfer_status = vsr.tigerbeetle.CreateTransferStatus;
pub const tb_create_account_result_t = vsr.tigerbeetle.CreateAccountResult;
pub const tb_create_transfer_result_t = vsr.tigerbeetle.CreateTransferResult;
