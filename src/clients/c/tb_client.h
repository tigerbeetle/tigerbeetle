...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_ALREADY_BALANCED_DEBIT_ACCOUNT = 46,
    TB_CREATE_TRANSFER_ALREADY_BALANCED_CREDIT_ACCOUNT = 47,
    TB_CREATE_TRANSFER_OVERFLOWS_DEBITS_PENDING = 48,
    TB_CREATE_TRANSFER_OVERFLOWS_CREDITS_PENDING = 49,
    TB_CREATE_TRANSFER_OVERFLOWS_DEBITS_POSTED = 50,
    TB_CREATE_TRANSFER_OVERFLOWS_CREDITS_POSTED = 51,
    TB_CREATE_TRANSFER_OVERFLOWS_DEBITS = 52,
    TB_CREATE_TRANSFER_OVERFLOWS_CREDITS = 53,
    TB_CREATE_TRANSFER_OVERFLOWS_TIMEOUT = 54,
    TB_CREATE_TRANSFER_EXCEEDS_CREDITS = 55,
    TB_CREATE_TRANSFER_EXCEEDS_DEBITS = 56,
