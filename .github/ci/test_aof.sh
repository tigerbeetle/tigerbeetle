...
./tigerbeetle-aof start --cache-grid=1024MiB --addresses=3001 aof-test.tigerbeetle >> aof.log 2>&1 &
...
../tigerbeetle-aof-recovery start --cache-grid=1024MiB --addresses=3001,3002 aof-test.tigerbeetle >> aof.log 2>&1 &
cd ..
