...
pub const TB_OPERATION_TB_OPERATION_CREATE_ACCOUNTS_WITH_RESULTS: TB_OPERATION = 146;
pub const TB_OPERATION_TB_OPERATION_CREATE_TRANSFERS_WITH_RESULTS: TB_OPERATION = 147;
