...
pub fn main(
    ...
    try workloads.appendSlice(allocator, &[_]Workload{
        ...
        Workload {
            ...
            .account_distribution_debit = cli_args.account_distribution_debit,
            .account_distribution_credit = cli_args.account_distribution_credit,
            .account_distribution_query = cli_args.account_distribution_query,
