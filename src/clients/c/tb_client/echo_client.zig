...
fn EchoStateMachineType(comptime StateMachine: type) type {
    return struct {
        ...
        pub const batch_event_max = StateMachine.batch_event_max;
        pub const batch_result_max = StateMachine.batch_result_max;
        pub const batch_results_expected = StateMachine.batch_results_expected;
