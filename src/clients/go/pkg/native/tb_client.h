...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_FLAGS = 26,
    TB_CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_DEBIT_ACCOUNT_ID = 27,
    TB_CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_CREDIT_ACCOUNT_ID = 28,
    TB_CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_USER_DATA = 29,
    TB_CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_PENDING_ID = 30,
    TB_CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_TIMEOUT = 31,
    TB_CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_CODE = 32,
    TB_CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_AMOUNT = 33,
    TB_CREATE_TRANSFER_EXISTS = 34,
    TB_CREATE_TRANSFER_OVERFLOWS_DEBITS_PENDING = 35,
    TB_CREATE_TRANSFER_OVERFLOWS_CREDITS_PENDING = 36,
    TB_CREATE_TRANSFER_OVERFLOWS_DEBITS_POSTED = 37,
    TB_CREATE_TRANSFER_OVERFLOWS_CREDITS_POSTED = 38,
    TB_CREATE_TRANSFER_OVERFLOWS_DEBITS = 39,
    TB_CREATE_TRANSFER_OVERFLOWS_CREDITS = 40,
    TB_CREATE_TRANSFER_OVERFLOWS_TIMEOUT = 41,
    TB_CREATE_TRANSFER_EXCEEDS_CREDITS = 42,
    TB_CREATE_TRANSFER_EXCEEDS_DEBITS = 43,
