...
For 20-30 years, general purpose databases like PostgreSQL, MySQL, and SQLite handled OLTP. We refer
...
- The UPI real-time payments switch in India processed 10 billion payments in the year 2019.
  In January 2025 alone, it processed [16.9 billion payments.](https://www.npci.org.in/what-we-do/upi/product-statistics)
- Cleaner energy and smart metering man energy is being traded by the kilowatt-hour.
...
It works well alongside OLGP databases, holding data that isn't updated very frequently.
