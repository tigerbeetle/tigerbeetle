...
public enum AccountFlags {
    ...
    public static AccountFlags fromValue(short value)
    {
        switch (value)
        {
            case Values.LINKED: return Linked;
            case Values.DEBITS_MUST_NOT_EXCEED_CREDITS: return DebitsMustNotExceedCredits;
            case Values.CREDITS_MUST_NOT_EXCEED_DEBITS: return CreditsMustNotExceedDebits;
            default: return None;
        }
    }
}
