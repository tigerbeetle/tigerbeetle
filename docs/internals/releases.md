...
9. On Monday (different release manager!) check that there are no VOPR failures on the release
   branch.

10. Trigger the release workflow via
...
11. Ask someone else to approve the GitHub workflow.

12. Add the new release sketch to the corresponding release page on
