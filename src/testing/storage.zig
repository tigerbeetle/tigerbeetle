...
pub const Storage = struct {
    ...
    fn pick_faulty_sector(
        ...
        return faulty_sectors.random(storage.prng.random());
    }
    ...
    fn pick_faulty_offset(storage: *Storage, write: *const Write) ?usize {
        ...
        const faulty_sector = storage.pick_faulty_sector(zone, 0, zone.size()).?;
        const faulty_offset = faulty_sector * constants.sector_size;
