...
typedef enum TB_CREATE_ACCOUNT_RESULT {
    ...
    TB_CREATE_ACCOUNT_IMPORT_TIMESTAMP_MUST_NOT_BE_ZERO = 22,
    TB_CREATE_ACCOUNT_IMPORT_REGRESSED_TIMESTAMP = 23,
    TB_CREATE_ACCOUNT_IMPORT_FUTURE_TIMESTAMP = 24,
...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_IMPORT_TIMESTAMP_MUST_NOT_BE_ZERO = 56,
    TB_CREATE_TRANSFER_IMPORT_REGRESSED_TIMESTAMP = 57,
    TB_CREATE_TRANSFER_IMPORT_FUTURE_TIMESTAMP = 58,
    TB_CREATE_TRANSFER_IMPORT_TIMEOUT_MUST_BE_ZERO = 59,
...
typedef enum TB_OPERATION {
    ...
    TB_OPERATION_IMPORT_ACCOUNTS = 135,
    TB_OPERATION_IMPORT_TRANSFERS = 136,
} TB_OPERATION;
