...
cmd="./zig/zig build benchmark -Dcpu=x86_64_v3+aes -Drelease-safe=true -- --account-count=10000 --transfer-count=10000000 --transfer-count-per-second=1000000 --addresses=${var.addresses} --statsd --print-batch-timings"
