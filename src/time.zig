...
pub const Time = struct {
    ...
    fn monotonic_darwin() u64 {
        ...
        const darwin = struct {
            const mach_timebase_info_t = std.posix.system.mach_timebase_info_data;
            extern "c" fn mach_timebase_info(info: *mach_timebase_info_t) std.posix.system.kern_return_t;
