...
public enum CreateTransferResult {
     ...
     */
    ExistsWithDifferentFlags((int) 26),
     ...
     */
    ExistsWithDifferentDebitAccountId((int) 27),
     ...
     */
    ExistsWithDifferentCreditAccountId((int) 28),
     ...
     */
    ExistsWithDifferentUserData((int) 29),
     ...
     */
    ExistsWithDifferentPendingId((int) 30),
     ...
     */
    ExistsWithDifferentTimeout((int) 31),
     ...
     */
    ExistsWithDifferentCode((int) 32),
     ...
     */
    ExistsWithDifferentAmount((int) 33),
     ...
     */
    OverflowsCreditsPending((int) 36),
