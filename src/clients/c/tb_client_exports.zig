...
pub const tb_create_account_result = vsr.tigerbeetle.CreateAccountStatus;
pub const tb_create_transfer_result = vsr.tigerbeetle.CreateTransferStatus;
pub const tb_create_accounts_result_t = vsr.tigerbeetle.CreateAccountResult;
pub const tb_create_transfers_result_t = vsr.tigerbeetle.CreateTransferResult;
