...
const ConfigProcess = struct {
    ...
    connection_delay_max_ms: u64 = 1_000,
    tcp_backlog: u31 = 64,
    ...
    backoff_max_ms: u64 = 10_000,
    clock_offset_tolerance_max_ms: u64 = 10_000,
    clock_epoch_max_ms: u64 = 60_000,
    clock_synchronization_window_min_ms: u64 = 2_000,
    clock_synchronization_window_max_ms: u64 = 20_000,
    ...
    multiversion_poll_interval_ms: u64 = 1_000,
};
