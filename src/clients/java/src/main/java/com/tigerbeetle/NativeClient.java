        ...
        if (contextHandle.getAcquire() != 0L) {
            synchronized (this) {
                ...
                if (handle != 0L) {
                    ...
                    // and spin wait until all references that might be using the handle
                    // could be released.
                    ...
                    while (contextHandleReferences.getAcquire() > 0L) {
                        ...
                        // in a spin loop.
                        // This has no side-effect and only provides a hint to optimize spin loops
                        // in a processor specific manner.
                        Thread.onSpinWait();
                    }
