...
pub fn StateMachineType(
    ...
    return struct {
        ...
        const AccountEventsGroove = GrooveType(
            ...
            AccountEvent,
            .{
                .ids = constants.tree_ids.account_events,
                ...
                .derived = .{
                    ...
                    .dr_account_closing_status = struct {
                        fn dr_account_closing_status(
                            _: *const AccountEvent,
                        ) ?AccountEventClosingStatus {
                            return null;
                        }
        ...
        pub const AccountEventClosingStatus = enum(u8) {
            ...
            comptime {
                for (std.enums.values(AccountEventClosingStatus), 0..) |result, index| {
        ...
        fn account_event(
            ...
            args: struct {
                ...
                dr_account_closing_status: AccountEventClosingStatus,
                cr_account: *const Account,
                cr_account_closing_status: AccountEventClosingStatus,
                transfer_flags: ?TransferFlags,
                transfer_pending_status: TransferPendingStatus,
            ...
            if (args.dr_account.flags.history) {
                ...
                if (args.dr_account_closing_status != .none) {
                    self.forest.grooves.account_events.indexes.dr_account_closing_status.put(&.{
                        .timestamp = args.event_timestamp,
            ...
            if (args.cr_account.flags.history) {
                ...
                if (args.cr_account_closing_status != .none) {
                    self.forest.grooves.account_events.indexes.cr_account_closing_status.put(&.{
                        .timestamp = args.event_timestamp,
