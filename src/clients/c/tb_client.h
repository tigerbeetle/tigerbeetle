...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_CANNOT_BALANCE_DEBIT = 41,
    TB_CREATE_TRANSFER_CANNOT_BALANCE_CREDIT = 42,
    TB_CREATE_TRANSFER_TIMEOUT_RESERVED_FOR_PENDING_TRANSFER = 43,
    TB_CREATE_TRANSFER_PENDING_ID_MUST_NOT_BE_ZERO = 44,
    TB_CREATE_TRANSFER_PENDING_ID_MUST_NOT_BE_INT_MAX = 45,
    TB_CREATE_TRANSFER_PENDING_ID_MUST_BE_DIFFERENT = 46,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_NOT_FOUND = 47,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_NOT_PENDING = 48,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_DEBIT_ACCOUNT_ID = 49,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_CREDIT_ACCOUNT_ID = 50,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_LEDGER = 51,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_CODE = 52,
    TB_CREATE_TRANSFER_EXCEEDS_PENDING_TRANSFER_AMOUNT = 53,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_AMOUNT = 54,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_ALREADY_POSTED = 55,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_ALREADY_VOIDED = 56,
    TB_CREATE_TRANSFER_PENDING_TRANSFER_EXPIRED = 57,
