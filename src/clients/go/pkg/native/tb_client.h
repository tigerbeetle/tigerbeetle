...
typedef enum TB_CREATE_ACCOUNT_RESULT {
    ...
    TB_CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_BE_ZERO = 24,
...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_BE_ZERO = 58,
    ...
    TB_CREATE_TRANSFER_IMPORTED_EVENT_DEBIT_ACCOUNT_MUST_NOT_ADVANCE = 61,
    TB_CREATE_TRANSFER_IMPORTED_EVENT_CREDIT_ACCOUNT_MUST_NOT_ADVANCE = 62,
