...
typedef enum TB_TRANSFER_FLAGS {
    ...
    TB_TRANSFER_CLOSING_DEBIT_ACCOUNT = 1 << 7,
    TB_TRANSFER_CLOSING_CREDIT_ACCOUNT = 1 << 8,
} TB_TRANSFER_FLAGS;
...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_DEBIT_ACCOUNT_CLOSED = 64,
    TB_CREATE_TRANSFER_CREDIT_ACCOUNT_CLOSED = 65,
