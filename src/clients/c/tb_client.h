...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_IMPORTED_EVENT_DEBIT_ACCOUNT_MUST_NOT_ADVANCE = 60,
    TB_CREATE_TRANSFER_IMPORTED_EVENT_CREDIT_ACCOUNT_MUST_NOT_ADVANCE = 61,
    TB_CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_REGRESS = 62,
