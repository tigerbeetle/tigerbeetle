...
const ConfigProcess = struct {
    ...
    grid_scrubber_cycle_ms: usize = std.time.ms_per_day * 365,
    grid_scrubber_interval_min_ms: usize = std.time.ms_per_s / 20,
    grid_scrubber_interval_max_ms: usize = std.time.ms_per_s,
