...
const supervisor = @import("./testing/systest/supervisor/supervisor.zig");
...
pub fn main() !void {
    ...
    switch (cli_args) {
        ...
        .systest => |args_systest| try supervisor.main(shell, gpa, args_systest),
    }
}
