...
public enum CreateAccountResult {
     ...
     */
    ImportTimestampMustNotBeZero((int) 4),

    /**
     * @see <a href="https://docs.tigerbeetle.com/reference/requests/create_accounts#import_timestamp_must_not_be_in_the_future">import_timestamp_must_not_be_in_the_future</a>
     */
    ImportTimestampMustNotBeInTheFuture((int) 5),
     ...
     */
    FlagsAreMutuallyExclusive((int) 10),
     ...
     */
    ExistsWithDifferentFlags((int) 17),
     ...
     */
    ExistsWithDifferentUserData128((int) 18),
     ...
     */
    ExistsWithDifferentUserData64((int) 19),
     ...
     */
    ExistsWithDifferentUserData32((int) 20),
     ...
     */
    ExistsWithDifferentLedger((int) 21),
     ...
     */
    ExistsWithDifferentCode((int) 22),
    ...
    /**
     * @see <a href="https://docs.tigerbeetle.com/reference/requests/create_accounts#import_timestamp_must_not_regress">import_timestamp_must_not_regress</a>
     */
    ImportTimestampMustNotRegress((int) 24);
